...
const { uploadFileToGCS_Service } = require("../Services/uploadFileToGCS");
...
describe("uploadFileToGCS_Service", () => {
  const mockConfig = {
  ...
  it("should upload the file to GCS with metadata", async () => {
    ...
    await uploadFileToGCS_Service(fileStreamFromUser, metadataFromUser);
    ...
    const expectedMetadata = {
      metadata: {
        ...metadataFromUser,
        SomeConstantValue1: "WhateverConstantValueIsRequired1",
        SomeConstantValue2: "WhateverConstantValueIsRequired2",
  ...
  it("should handle errors when uploading files", async () => {
    ...
    await expect(
      uploadFileToGCS_Service(fileStreamFromUser, metadataFromUser)
